...
if contract_no="C2017121817555906582711" and cut_date=mdy(12,14,2019) then 还款_当日流入15加合同=0;
if contract_no="C2018052117442350226354" and cut_date=mdy(12,14,2019) then 还款_当日流入15加合同=0;
