...
if branch_name in ("上海福州路营业部","合肥站前路营业部","盐城市第一营业部") then 分中心 = "上海分中心";
	...
	else if branch_name in ("成都天府国际营业部","昆明市第一营业部","武汉市第一营业部","贵阳市第一营业部") then 分中心 = "成都分中心";
...
if BRANCH_NAME in ("上海福州路营业部","合肥站前路营业部","盐城市第一营业部","杭州建国北路营业部",
	...
	else if BRANCH_NAME in ("呼和浩特市第一营业部","北京市第一营业部","成都天府国际营业部","昆明市第一营业部",
...
sum(还款_M1合同贷款余额)/sum(贷款余额_1月前_C) as c_m1 format=percent7.2,
