...
if contract_no in ('C2017091214165415037622','C2017092116242511247031','C2017071215142043171242','C2017033017190011763012','C2018051711594971854092','C2017112218403870825073','C2018011917511864766167',
	...
	'C2017092218030277297782','C2017071011182562875373','C2017072016551090279522','C2017063011253120140972','C2017111309180373249713','C2018020815263704596907','C2018011109495917800533',
	'C2017091916541144588522','C2017083109172614420468','C2017112116543580906345','C2017080716413641799350','C2017100917165257502751','C2017091418150993678214','C2017101713554923504012',
	'C2017112113064601715370','C2018061120080975173663','C152877217603603000000666','C2018033015470722765181','C2017121417194606313843') then delete;
if contract_no='C2017101817490514604829' then do;CURR_RECEIPT_AMT=19644.0795;佣金=841.88925;end;
...
if contract_no='C152652124436102300000511' then do;CURR_RECEIPT_AMT=53994.82;佣金=2447.8227;end;
if contract_no='C152716159957403000000156' then do;CURR_RECEIPT_AMT=17060;佣金=434.466;end;
run;
proc sort data=pre_list_8;by descending clear_date;run;
/*filename DD DDE "EXCEL|[提前结清名单.xlsx]已结清明细!r2c1:r100c6";*/
